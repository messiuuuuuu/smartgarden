...
const AddGroup = ({ newGroupName, setNewGroupName, onAddGroup, onCancel }) => (
    <div className="w-full max-w-7xl mb-8 p-6 bg-white rounded-xl shadow-md border border-gray-200">
        ...
        <div className="flex gap-4 items-center">
            <input
                ...
                className="flex-1 p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 bg-green-50/50"
            />
            <button
                onClick={onAddGroup}
